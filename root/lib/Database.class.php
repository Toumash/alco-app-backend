...
class Database extends mysqli
{
    ...
    public function __construct()
    {
        ...
        parent::__construct($server, $login, $password, $database); //or die("MySQL connection error. Please try again later".$db_info->DB_LOGIN.$db_info->DB_PASS.$db_info->DB_SERVER.$db_info->DB_DB);
